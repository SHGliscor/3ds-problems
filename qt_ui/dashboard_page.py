...
class DashboardPage(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        # Collapsible Current Hunt details. The toggle keeps the panel header
        # visible while allowing the detailed hunt fields to be minimized.
        hunt_toggle = QCheckBox("Show details")
        hunt_toggle.setChecked(True)
        hunt_toggle.setToolTip("Show or minimize the Current Hunt details.")
        hunt_info.outer.addWidget(hunt_toggle)

        hunt_details = QWidget()
        hunt_details.setObjectName("CurrentHuntDetails")
        hunt_details.setLayout(g)
        hunt_info.outer.addWidget(hunt_details)

        def _toggle_hunt_details(visible):
            hunt_details.setVisible(bool(visible))

        hunt_toggle.toggled.connect(_toggle_hunt_details)
        self.current_hunt_toggle = hunt_toggle
        self.current_hunt_details = hunt_details
